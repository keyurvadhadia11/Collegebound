...
<html lang="en">
    ...
    <head>
      ...
      <?php
        ...
        function cgbound_enqueue_scripts() 
    ...
    <body <?php body_class(); ?> >
      ...
      <div class="main-wrapper">
        ...
        <div class="content-wrapper">
                  ...
                  <ul class="navbar-nav ml-auto flex-row align-items-center">
                     ...
                     <li class="nav-item nav-dropdown-profile dropdown">
                        ...
                        <?php
                          ...
                          $dpImageUrl = 'https://ui-avatars.com/api/?background=random&name='.get_user_meta($userId, 'first_name', true).'+'.get_user_meta($userId, 'last_name', true);
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                           ...
                           <a class="dropdown-item" href="<?php echo site_url('player-profile');?>">My Profile</a>
            ...
            <div id="searchbox" class="search-box">
               ...
               <div class="search-box-wrap">
                  <form autocomplete="off" action="<?php echo site_url('coach-search');?>">
                     <input type="text" class="form-control" placeholder="Type search..." name="search" id="search">
            ...
            <?php 
            // Only Player And Admin Access Player Pages
            if( !current_user_can('player') && !current_user_can('administrator') ){
            	// If User Have Coach Than, User Redirect to Coach-Dashboard
            	...
            	// If User Have Event Operator Than, User Rediret to Event Operator Dashboard
