        ...
        <div class="content-wrapper">
            ...
            <div id="searchbox" class="search-box">
               ...
               <div class="search-box-wrap">
                  ...
                  <form autocomplete="off" action="<?php echo site_url('player-search');?>">
            ...
            <?php 
            // Only Player View Coach And Event Operator Pages redirect to player dashboard
            if( current_user_can('player') && !current_user_can('administrator') ){
            ?>
            <script type="text/javascript">
              window.location.href = "<?php echo site_url('player-dashboard');?>";
            </script>
            <?php 
            exit;
            }