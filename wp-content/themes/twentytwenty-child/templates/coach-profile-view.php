<?php
/**
 * Template Name: Coach Profile View
 */ 
...
if( !empty($_GET['user_id']) ) {
  if( empty(get_userdata($_GET['user_id'])) ){ 
          ...
          <div class="col-xl-4 col-lg-6">
            <div class="card-college">
              ...
              <div class="card-college-content pb-0">
                ...
                <h4 class="mb-0"><?php echo get_user_meta( $userId, 'universitycollege', true);?></h4>
              ...
              <?php 
                ...
                <div class="card-college-list">
                  <div class="card-college-list-image">
                    <?php
                  ...
                  <div class="card-college-list-content">
                    <h4><?php echo get_user_meta( $user->ID, 'first_name', true);?> <?php echo get_user_meta( $user->ID, 'first_name', true);?></h4>

                    <p>Michigan State University Head Women’s Basketball Coach</p>
