<?php
/**
 * Template Name: Operator Profile Edit
 */ 
                  ...
                  <div class="row gutters-10">
                    <div class="col-lg-12">
                      <div class="text-center mb-5">
                        <input type="hidden" name="action" value="operator-profile-edit">
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-input">
                        <label class="form-label active">Operator Title</label>
                        <input type="text" class="form-control" value="<?php echo $user_info->coachtitle;?>" name="coachtitle">
