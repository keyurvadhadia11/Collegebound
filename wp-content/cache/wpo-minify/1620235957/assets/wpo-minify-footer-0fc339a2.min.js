 ...
 *   https://datatables.net/download/#bs4/dt-1.10.22/af-2.3.5/b-1.6.5/b-colvis-1.6.5/b-flash-1.6.5/b-print-1.6.5/cr-1.5.3/fc-3.3.2/fh-3.1.7/kt-2.5.3/r-2.2.6/rg-1.1.2/rr-1.2.7/sc-2.0.3/sb-1.0.1/sp-1.2.2/sl-1.3.1
 *
 * Included libraries:
 *  DataTables 1.10.22, AutoFill 2.3.5, Buttons 1.6.5, Column visibility 1.6.5, Flash export 1.6.5, Print view 1.6.5, ColReorder 1.5.3, FixedColumns 3.3.2, FixedHeader 3.1.7, KeyTable 2.5.3, Responsive 2.2.6, RowGroup 1.1.2, RowReorder 1.2.7, Scroller 2.0.3, SearchBuilder 1.0.1, SearchPanes 1.2.2, Select 1.3.1
 */
...
e=f.bPaginate;return f.bServerSide?!1===e||-1===a?b+d:Math.min(b+a,this._iRecordsDisplay):!e||c>d||-1===a?d:c},oInstance:null,sInstance:null,iTabIndex:0,nScrollHead:null,nScrollFoot:null,aLastSort:[],oPlugins:{},rowIdFn:null,rowId:null};u.ext=L={buttons:{},classes:{},builder:"bs4/dt-1.10.22/af-2.3.5/b-1.6.5/b-colvis-1.6.5/b-flash-1.6.5/b-print-1.6.5/cr-1.5.3/fc-3.3.2/fh-3.1.7/kt-2.5.3/r-2.2.6/rg-1.1.2/rr-1.2.7/sc-2.0.3/sb-1.0.1/sp-1.2.2/sl-1.3.1",errMode:"alert",feature:[],search:[],selector:{cell:[],column:[],row:[]},internal:{},legacy:{ajax:null},pager:{},renderer:{pageButton:{},header:{}},order:{},type:{detect:[],search:{},order:{}},_unique:0,fnVersionCheck:u.fnVersionCheck,
...
jQuery(document).ready(function($){var canvas=document.getElementById("salescanvas");var ctx=canvas.getContext('2d');var thismonth=jQuery('#thismonth').val();Chart.defaults.global.defaultFontColor='#545455';Chart.defaults.global.defaultFontSize=12;jQuery.ajax({url:college_bound_ajax_object.ajax_url,method:"GET",data:{action:'get_sales_chart_data',thismonth:thismonth},dataType:"json",success:function(response){var months=response.months;var price_values=response.price_values;var data={labels:months,datasets:[{label:"Sales $",fill:!1,borderColor:'#46C5F8',data:price_values,borderWidth:6,pointBorderWidth:10,pointHoverRadius:8,pointRadius:4,pointStyle:'circle',pointHitRadius:10,}]};var options={title:{display:!0,text:'',position:'bottom'},scales:{yAxes:[{ticks:{beginAtZero:!0,},}],xAxes:[{gridLines:{display:!1,drawBorder:!1,},}],},legend:{display:!0},};var myBarChart=new Chart(ctx,{type:'line',data:data,options:options,responsive:!0,})},error:function(error){console.log("error")}})});
